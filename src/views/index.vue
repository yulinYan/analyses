        ...
        <div class="leftContent">
          <div class="leftOne">
            ...
            <div class="leftOneEchart">
              <div class="scrollBox">
                <div
                  class="leftOneEchartScroll"
                  id="microserviceAutoScoll"
                  @mouseover="msvAutoScollMouseover"
                  @mouseout="msvAutoScollMouseout"
                >
                  <div id="msvBoxOne">
                    <label
                      v-for="(item, index) in pagesData.percentage"
                      :key="index"
                    >
                      <span
                        style="
          ...
          <div class="leftThree">
            <div class="leftThreeTitle">
              <span>事件单</span>
              <span>告警中心</span>
            </div>
            <div class="leftThreeEchart">
              <el-table
                :data="pagesData.eventData"
                style="width: 48%"
                height="100%"
                align="center"
        ...
        <div class="middleContent">
          <div class="middleOneTitle">
            <div class="middleOneTitleSmall">
              <h3>耗时</h3>
              <span class="middleOneTitleData">{{middleTopFirst}} </span><span>/sec</span>
            </div>
            <div class="middleOneTitleBig">
              <h3>当日总交易量当前TPS</h3>
              <span class="middleOneTitleData">{{middleTopSecond}}</span><span>/TPS</span>
            </div>
            <div class="middleOneTitleSmall">
              <h3>失败率</h3>
              <span class="middleOneTitleData">{{middleTopThird}}</span><span>%</span>
            </div>
            <div class="middleOneTitleBig">
              <h3>总结点数</h3>
              <span class="middleOneTitleData">{{middleTopFour}}</span><span>/台</span>
            </div>
          </div>
          <div class="middleTwo">
            ...
            <el-collapse-transition>
              <!-- <div v-if="show3"> -->
                <el-dialog title="应用选择" :visible.sync="show3">
                  <el-tree ref="tree" :data="dialogData" :props="defaultProps" accordion highlight-current 
                        show-checkbox
                        node-key="label"
    	                  :check-strictly="true"
          ...
          <div class="middleThree">
            <div class="middleThreeTitle">今日实时统计</div>
...
export default {
  ...
  mounted() {
    this.autoScroll();
    this.oleftTwoEcharts = this.$echarts.init(
      document.getElementById("leftTwoEcharts")
    );
    this.oMiddleThreeEcharts1 = this.$echarts.init(
      document.getElementById("middleThreeEcharts1")
    );
    this.oMiddleThreeEcharts2 = this.$echarts.init(
      document.getElementById("middleThreeEcharts2")
    );
    this.oMiddleThreeEcharts3 = this.$echarts.init(
      document.getElementById("middleThreeEcharts3")
    );
    this.oRightOneEchartId = this.$echarts.init(
      document.getElementById("rightOneEchartId")
    );
    this.oRightTwoEchart1 = this.$echarts.init(
      document.getElementById("rightTwoEchart1")
    );
    this.oRightTwoEchart2 = this.$echarts.init(
      document.getElementById("rightTwoEchart2")
    );
    this.oRightTwoEchart3 = this.$echarts.init(
      document.getElementById("rightTwoEchart3")
    );
    this.oRightTwoEchart4 = this.$echarts.init(
      document.getElementById("rightTwoEchart4")
    );
  ...
  methods: {
    ...
    autoScroll() {
      ...
      var microserviceSscollTop = document.getElementById(
        "microserviceAutoScoll"
      );
        ...
        series: [
          {
            ...
            data: [
              { value: 210, name: "0~25%" },
              { value: 834, name: "26%~50%" },
              { value: 435, name: "51%~75%" },
              { value: 1048, name:"76%~100%" },
            ],
          },
        ]
      };
        ...
        series: [
          {
            ...
            data: [
              { value: 1310, name: "0~25%" },
              { value: 234, name: "26%~50%" },
              { value: 135, name: "51%~75%" },
              { value: 548, name:"76%~100%" },
            ],
          },
        ]
      };
        ...
        series: [
          {
            ...
            data: [
              { value: 210, name: "0~25%" },
              { value: 334, name: "26%~50%" },
              { value: 1135, name: "51%~75%" },
              { value: 548, name:"76%~100%" },
            ],
          },
        ]
